...
export let debounceSuggestionTimer;

// Sleep Timer State
export let sleepTimerId = null;
export let sleepTimerCountdownIntervalId = null;
...
export const defaultStationIconSvg = document.getElementById('defaultStationIcon');
...
// These functions directly modify the state variables.
// They are kept here to colocate state management.
...
export function setDebounceSuggestionTimer(timer) {
    debounceSuggestionTimer = timer;
}
