import { searchInput, searchTypeSelect, statusDiv, playPauseBtn, playerPool, stations, suggestionsContainer, searchBtn, currentSuggestionIndex, currentSearchTerm, // Import state variables directly
currentSearchType, setCurrentSearchType, setCurrentSearchTerm, setStationListIndex, setStations, setIsPlaying, setCurrentSearchOffset, setCurrentSuggestionIndex } from '../state.js';
...
export function handleSearchOrClear(isRandomSearch = false) {
    ...
    if (isRandomSearch) {
        ...
        if (searchTypeSelect) {
            setCurrentSearchType(searchTypeSelect.value);
        }
